...
<body>
    <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid text-medium">
            <a class="navbar-brand" href="index.php"><b class="logo-style-left main-logo">Concert</b><b class="logo-style-right main-logo">Hubble</b></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form id="search-bar" class="d-flex" action="search-page.php" method='GET'>
